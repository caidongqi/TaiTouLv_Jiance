...
def read_data():
    path = r'C:\Users\86132\Desktop\py_excel.xlsx'
...
img = r'C:\Users\86132\Desktop\dlib\dlib-master\examples\faces\2.jpg'
...
def pic_re():
    if (flag.get() == 0):
        ...
        img = os.path.join(r'C:\Users\86132\Desktop\dlib\dlib-master\examples\faces', pic_path)
        img_open = Image.open(img)
        # 显示图片的代码
        (x, y) = img_open.size  # read image size
        global x_s
...
def inspect():
    str1 = "教室"
    str2 = "课上的抬头人数为："
    path = r'C:\Users\86132\Desktop\dlib\dlib-master\examples\faces'
    pic_path = str(class_room_chosen.get()) + str(course_time_chosen.get()) + '.jpg'
    p = path +'/'+pic_path
    img = cv2.imread(p)
    color = (0, 255, 0)
    ...
    classfier = cv2.CascadeClassifier(
        r"C:\Users\86132\Desktop\opencv-master\data\haarcascades\haarcascade_frontalface_alt2.xml")
